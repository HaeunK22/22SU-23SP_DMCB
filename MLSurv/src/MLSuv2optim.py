...
class VAE(torch.nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        return decoder1_, decoder2_, decoder3_, decoder4_, comm1, spe1, comm2, spe2, mu1, sigma1, mu2, sigma2, inputmlp
    
    
class MLSurv(torch.nn.Module):
    def __init__(self, input_dim, dim1, dim2):
        super(MLSurv, self).__init__()
        self.vae = VAE(input_dim, dim1, dim2)
    ...
    def forward(self, x1, x2):
        decoder1_, decoder2_, decoder3_, decoder4_, comm1, spe1, comm2, spe2, mu1, sigma1, mu2, sigma2, inputmlp = self.vae(x1, x2)
